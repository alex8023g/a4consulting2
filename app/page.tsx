...
export default function Home() {
  return (
    <>
      ...
      <div className='/min-h-screen flex flex-col overflow-hidden rounded-b-[60px] bg-[#232829] px-[16px] pb-[150px] xl:px-0'>
        <div className='/px-[352px] mx-auto max-w-[1240px] pt-[20px] xl:pt-[153px]'>
          ...
          <div className='relative flex flex-col border border-red-500 xl:flex-row xl:gap-[88px]'>
            <div className='relative mx-auto h-[200px] w-full border border-blue-500 xl:mx-0 xl:h-[767px] xl:w-[381px]'>
              <Image
                src={'/img/man.png'}
                alt='Fitness hero'
                fill
            ...
            <div className='/mx-auto flex flex-col gap-[14px] xl:mx-0'>
